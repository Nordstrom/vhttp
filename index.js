...
class Vhttp {
    constructor(virtual, ctraceRequest) {
        this.virtual = virtual;
        if (ctraceRequest) {
            this.ctraceRequest = ctraceRequest;
            ctraceRequest.init(request);
        }
    }
    ...
    _sendReal(opts) {
        var requestLibrary = request;
        if (this.ctraceRequest) {
            requestLibrary = this.ctraceRequest;
        }
        return requestLibrary(opts)
          .then(function (data) {
